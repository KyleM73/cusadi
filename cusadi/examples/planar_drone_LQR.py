...
fn_drone_LQR = ca.Function.load(os.path.join(cu.CUSADI_FUNCTION_DIR, "drone_sim_LQR_sweep.casadi"))
step_drone_LQR = cu.CusadiFunction(fn_drone_LQR, N_ENVS)
...
scipy.io.savemat(f"{cu.CUSADI_DATA_DIR}/drone_LQR_data.mat", data_MATLAB)